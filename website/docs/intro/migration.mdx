...
Should any of the following steps fail, please stop; do not proceed. Instead, follow the
[rollback instructions below](#rolling-back-to-terraform-and-reporting-issues).
